...
You can also sort, tag and filter your contacts for easy organization.</p>
  ...
  <section class="sec9">
    <div class="container">
      <div class="row text-center">
        <div class="col-md-4">
          <img src="assets/img/contact_phone_icon.svg" />
          <h2>Contact us</h2>
          <p>Feel free to reach out, we would love to hear from you.</p>
          <a href="#" class="btn btn-default btn-primary">Contact us</a>
        </div>
        <div class="col-md-4">
          <img src="assets/img/helpsite_icon.svg" />
          <h2>Questions? We can help</h2>
          <p>Questions about getting started? Visit our extensive helpsite now.</p>
          <a href="#" class="btn btn-default btn-primary">Go to helpsite</a>
        </div>
        <div class="col-md-4">
